...
public partial class CorsoNetGennaioContext : DbContext
{
    public CorsoNetGennaioContext(DbContextOptions<CorsoNetGennaioContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<LogAccessi> LogAccessis { get; set; }
    ...
    public virtual DbSet<Sessioni> Sessionis { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable("LogAccessi");

            entity.Property(e => e.Id).HasColumnName("id");
            entity.Property(e => e.DaDove)
                .IsRequired()
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.DataTentativo).HasColumnType("smalldatetime");
        ...
        modelBuilder.Entity<Utenti>(entity =>
        {
            ...
            entity.Property(e => e.Cognome)
                ...
                .HasMaxLength(50)
                .IsUnicode(false);
            entity.Property(e => e.DataUltimoAccesso).HasColumnType("smalldatetime");
